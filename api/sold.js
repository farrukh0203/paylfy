...
const ACCESS_TOKEN  = 'EAAQRGvuUf0IBRZAXAgJIVPuEwTG9g4MDUrr8sshZCYt3ZCwA6pzoCrzTIC1uxWuwbtLjMLtCD21AAe7fsiJihfQBLZBG5K5iCRhznjISMLSGs8YMP64pcIZCkn2IrEtVLS11AWyZBUvfJI0thhhVAZC2XRHKsAx2uTprLeP5KX2Xn8NKTVmn74uYgicSNdcTg9nZAAZDZD';
        ...
        if (contacts.length > 0) {
          ...
          for (const f of (contactData?.custom_fields_values || [])) {
            if (f.field_code === 'PHONE' && f.values?.[0]?.value) {
              phone = cleanPhone(f.values[0].value);
              break;
            }
          }
        }
          ...
          'https://graph.facebook.com/v19.0/' + PIXEL_ID + '/events?access_token=' + ACCESS_TOKEN,
          {
            ...
            body: JSON.stringify({
              data: [{
                ...
                action_source:    'crm',
                event_source_url: 'https://paylfy-capi.vercel.app',
